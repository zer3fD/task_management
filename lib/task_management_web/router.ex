defmodule TaskManagementWeb.Router do
  ...
  import TaskManagementWeb.UserAuth
  ...
  scope "/", TaskManagementWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TaskManagementWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TaskManagementWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TaskManagementWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TaskManagementWeb do
    ...
    live_session :current_user,
      on_mount: [{TaskManagementWeb.UserAuth, :mount_current_user}] do
